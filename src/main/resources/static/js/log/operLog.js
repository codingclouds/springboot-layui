...
var pageCurr;
var form;
var OPERTYPE_SET={"1":"新增","2":"查询","3":"删除","4":"更新"}
$(function() {
    ...
    layui.use('table', function(){
        ...
        tableIns=table.render({
            ...
            cols: [[
                ...
                ,{field:'busi', title: '操作模块',align:'center'}
                ,{field:'operType', title: '操作类型',align:'center'}
                ...
                $("[data-field='operType']").children().each(function(){
                    if($(this).text()=='1'){
                        ...
                        $(this).html("<button type='button' class='layui-btn layui-btn-normal layui-btn-radius layui-btn-xs'>查询</button>");
                    }else if ($(this).text()=='3'){
                        $(this).html("<button type='button' class='layui-btn layui-btn-danger layui-btn-radius layui-btn-xs'>删除</button>");
                    } else if($(this).text()=='4'){
                        $(this).html("<button type='button' class='layui-btn layui-btn-warm layui-btn-radius layui-btn-xs'>更新</button>");
                    }
                });
